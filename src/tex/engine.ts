...
/** Served as static files from public/tex by scripts/fetch-tex-assets.sh. */
const ASSET_URLS = {
  bundlesUrl: '/tex/bundles',
  wasmUrl: '/tex/busytex.wasm',
  jsUrl: '/tex/busytex.js',
  // The engine spawns this itself. It must be a plain static file, because a
  // bundler would otherwise rewrite the package's internal worker path.
  workerUrl: '/tex/worker.js',
} as const;
